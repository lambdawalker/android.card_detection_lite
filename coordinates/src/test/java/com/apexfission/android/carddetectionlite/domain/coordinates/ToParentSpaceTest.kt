...
import com.apexfission.android.carddetectionlite.domain.coordinates.transformations.toParentSpace
import org.junit.Test


class ToParentSpaceTest {
    @Test
    fun sameSpace() {
        ...
        val result = imagePoint.toParentSpace(parentSpace, childSpace)
    ...
    fun croppedAndMovedSpace() {
        ...
        val imagePoint = ImagePoint(10, 10)
        val expected = ImagePoint(110, 110)
        val result = imagePoint.toParentSpace(parentSpace, childSpace)
    ...
    fun croppedMovedAndScaledSpace() {
        ...
        val imagePoint = ImagePoint(20, 20)
        val expected = ImagePoint(110, 110)
        val result = imagePoint.toParentSpace(parentSpace, childSpace)
